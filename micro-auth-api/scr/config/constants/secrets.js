...
export const DB_USER = env.DB_USER ? env.DB_USER : "suplament";
export const DB_PASSWORD = env.DB_PASSWORD ? env.DB_PASSWORD : "suplament123";
export const DB_PORT = env.DB_PORT ? env.DB_PORT : "5435";
